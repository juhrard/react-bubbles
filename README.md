...
A token is used to send authentication information between an api and an application.

- [ ] What steps can you take in your web apps to keep your data secure?

We can limit our content to logged in users, or users with a token.

- [ ] Describe how web servers work.

Web servers serve content to computers around the world. They're big computers that are always on supplying and maintaining data.
